      ...
      <div className="flex flex-wrap md:justify-between container justify-center">
        <div className="font-sourceSans text-center md:text-left lg:w-1/2">
          ...
          <Link
            href={"#newProduct"}
            scroll={false}
            className={`inline-block px-8 py-[10px] text-white font-sourceSans text-base drop-shadow-md tracking-wide mt-6 font-semibold rounded-full hover:bg-on transition-all duration-300 bg-gradient-to-r from-lightBlue to-darkBlue`}>
            What's New ?
          </Link>
        </div>
        <div className="">
